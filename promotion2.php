...
<html lang="en" dir="ltr">
  ...
  <title>Admin_Electronabli</title>
          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.html">
                ...
                <span class="brand-name">Electronabli</span>
              </a>
            </div>
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard"
                      ...
                      <span class="nav-text">Produit</span> <b class="caret"></b>
                    </a>
                  ...
                  <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#ui-elements"
                      ...
                      <span class="nav-text">Promotions</span> <b class="caret"></b>
                    </a>
                        ...
                        <li  class="has-sub active expand" >
                          ...
                          <ul  class="collapse show"  id="components">
                            <div class="sub-menu">
                              ...
                              <li  class="active" >
                                <a href="promotion2.php">Les promotions</a>
                              </li>
                              
                              <li >
                                <a href="ajouterpromotion2.php">Ajouter promotion</a>
                              </li>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block">Fourat Lahmar</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        ...
                        <div class="d-inline-block">
                          fourat Lahmar <small class="pt-1">Fourat.Lahmar@gmail.com</small>
                        </div>
                      </li>
              ...
              Promotions
                  ...
                  <?php
                        ...
                        if (isset($_POST['modifier2'])){
                            $promotion=new promotion($_POST['Id_promo'],$_POST['Promo'],$_POST['Datepromo']);
                            $promotion1C=new promotionC($_POST['Id_promo'],$_POST['Promo'],$_POST['Datepromo']);
                            $promotion1C->modifierpromo($promotion,$_POST['Id_promo']);
                 ...
                 ?>
                  <div class="card card-table-border-none" id="promotion">
                    ...
                    <div class="card-body pt-0 pb-5">
                      <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                        <thead>
                          <tr>
                            <th>Id_promo</th>
                            <th>Promo</th>
                            <th class="d-none d-md-table-cell">Datepromo</th>
                            <th></th>
                          </tr>
                        </thead>
                        <tbody>
                        <?php
                        if(is_array($listepromotion) || is_object($listepromotion)){
                        ...
                        ?>
                         <tr>
                          <tr>
                            ...
                            <td >
                              <a class="text-dark" href=""> <?PHP echo $row['Promo']; ?></a>
                            </td>
                            <td class="d-none d-md-table-cell"><?PHP echo $row['Datepromo']; ?></td>
                            <form method="POST" action="Modifier2.php">
                            <td>
                            <button type="submit" class="mb-1 btn btn-success">
														<i class=" mdi mdi-diamond-outline mr-1"></i>Modifier</button></td>
                            <input type="hidden" value="<?php echo $row['Id_promo'];?>" name="Id_promo">
                            </form>
                            <form method="POST" action="supprimer.php">
                            <td><button type="submit" class="mb-1 btn btn-danger">
														<i class=" mdi mdi-close-circle-outline mr-1"></i>Supprimer</button></td>
                            <input type="hidden" value="<?php echo $row['Id_promo'];?>" name="Id_promo">
                            </form>
                      ...
                      <a href="ajouterpromotion2.php">ajouter une nouvelle promotion </a>
                    </div>
                  </div>
</div>
							</div>						
