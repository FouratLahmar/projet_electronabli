      ...
      <div class="page-wrapper">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item" aria-current="page">Ajouter Promotion</li>
          </ol>
        </nav>
                  ...
                  <div class="card card-table-border-none" id="promotion">
                    ...
                    <form class="" action="ajouterpromotion.php" method="post">
                      <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                        ...
                        <tbody>
                         <tr>
                          <tr>
                            <td ><input type="text" name="Id_promo" value=""></td>
                            <td >
                            <input type="text" name="Promo" value="">
                            </td>
                            <td ><input type="date" name="Datepromo" value=""></td>
