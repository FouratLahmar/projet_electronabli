          ...
          <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item" aria-current="page">table</li>
                  ...
                  <?PHP
                            ...
                            $result=$promotion1C->trouverpromo($_POST['Id_promo']);
                            if(is_array($result) || is_object($result)){
                            foreach($result as $row){
                            $Id_promo=$row['Id_promo'];
                            $Promo=$row['Promo'];
                            $Datepromo=$row['Datepromo'];?>
                  <div class="card card-table-border-none" id="promotion">
                    ...
                    <form method="POST" action="promotion2.php">
                      <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                        ...
                        <tbody>
                         <tr>
                          <tr>
                            <td ><input type="text" name="Id_promo" value="<?PHP echo $Id_promo ?>" disabled></td>
                            <td >
                            <input type="text" name="Promo" value="<?PHP echo $Promo ?>">
                            </td>
                            <td ><input type="date" name="Datepromo" value="<?PHP echo $Datepromo ?>"></td>
                            
                            <td><input type="submit" name="modifier2" value="modifier"></td>
                            </tr>
                            <tr>
                            <input type="hidden" name="Id_promo" value="<?PHP echo $_POST['Id_promo'];?>">
                            </tr>
                          </tr>
                          <?PHP
			}}
